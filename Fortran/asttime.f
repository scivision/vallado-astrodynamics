...
*
*    current :
*               8 jul 07  david vallado
*                           change jd routines to 2-part for accuracy
*    changes :
...
* ----------------------------  Locals  -------------------------------
		...
		dt = jd - IDINT(jd)
		if (ABS(dt - 0.5) .gt. 0.00000001D0) THEN
...
* ----------------------------  Locals  -------------------------------
        ...
        IF ( TypeUTIn .eq. '1' ) THEN
            ...
            CALL jday( Year,Mon,Day, LocalHr, minute, SEC, 
     &                 JDUT1, JDUT1F )
            TUT1= (JDUT1+JDUT1F - 2451545.0D0 )/ 36525.0D0
...
*        CALL jday( Year,Mon,Day, HrTemp, MinTemp, SecTemp, JDTAI)
        ...
        CALL jday( Year,Mon,Day, HrTemp, MinTemp, SecTemp, 
     &        JDTT, JDTTF)
        TTT= (JDTT+JDTTF - 2451545.0D0 )/ 36525.0D0
